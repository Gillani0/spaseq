...
public class DictionaryOpImpl implements DictionaryOpApi {
	...
	private final static HashBiMap<Resource, Long> resourcesAdaptive = HashBiMap.create(); /// first
																							/// copy
																							/// the
																							/// statefull
																							/// ones
	...
	private final static HashBiMap<Resource, Long> resourcesIncremental = HashBiMap.create(); /// first
																								/// copy
																								/// the
																								/// statefull
																								/// ones
	...
	public boolean checkStatefullSMap(Long l) {
		/*
		 * if(resourcesPersistant.containsValue(l)){ return true; }else if
		 * (bNodePersistant.containsValue(l)){ return true; }
		 */
	...
	public void checkStatefullSValue(Object o, Long l) {
		...
		/*
		 * if(o instanceof Resource){ resourcesPersistant.put((Resource)o,l);
		 * }else if(o instanceof BNode){ bNodePersistant.put((BNode)o, l); }
		 */
	...
	public boolean checkStatefullOMap(Long l) {
		/*
		 * if(literalsPersistant.containsValue(l)){ return true; }else if
		 * (bNodePersistant.containsValue(l)){ return true; }
		 */
	...
	public void checkStatefullOValue(Object o, Long l) {
		...
		/*
		 * if(o instanceof Literal){ literalsPersistant.put((Literal)o,l); }else
		 * if(o instanceof BNode){ bNodePersistant.put((BNode)o, l); }
		 */
