...
public class StreamHandler implements Runnable{
   ...
   private final NxParser parser;
	...
	public StreamHandler(BlockingQueue<GraphEvent> q, String name, int waitTime, NxParser p,DictionaryOpImpl dic, int b) {  ///send the nx over here in the file
		this.q=q;
...
//			q.add(new GraphEvent(counter++,System.nanoTime(),this._dictImpl,contxt,ep));
