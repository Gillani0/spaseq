...
public class EngineController {
	...
	public void setNFADataList(List<NFAData> nfaDataList, List<PatternData> pattData) {
		...
		/***
		 * Addition of UNION and OR get the list, merge them and then sort it
		 */
	...
	/*
	 * public void runEngine() throws Exception { myEngine.runEngine();
	 * 
	 * }
	 */
	...
	/*
	 * public EngineNormal getMyEngine() { return myEngine; }
	 * 
	 * public void setMyEngine(EngineNormal myEngine) { this.myEngine =
	 * myEngine; }
	 */
